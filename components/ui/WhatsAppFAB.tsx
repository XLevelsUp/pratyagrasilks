...
const WhatsAppFAB = () => {
  // Note: The store owner should update this with their actual WhatsApp number
  ...
  return (
    <div className='fixed bottom-5 right-5 z-[9999] flex items-center justify-center group'>
      {/* Tooltip */}
      ...
      <a
        ...
        className='relative flex items-center justify-center w-14 h-14 md:w-[60px] md:h-[60px] bg-[#25D366] hover:bg-[#1ebe57] rounded-full shadow-lg transition-transform duration-300 hover:scale-110'
